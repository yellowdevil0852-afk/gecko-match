...
const allBehaviors = [
    ...
    { id: 1, content: './images/calcium_dusting.png', label: '補充鈣粉', type: 'good', description: '鈣質對守宮的骨骼發育至關重要。定期在昆蟲飼料中裹上適量鈣粉，能有效預防守宮罹患嚴重的代謝性骨病。' },
    ...
    { id: 9, content: './images/quiet_observing.png', label: '安靜觀察不打擾', type: 'good', description: '守宮是害羞的夜行性爬蟲。白天牠們多在睡覺，保持環境安靜、減少過度打擾，能大大降低寵物的精神壓力。' },
    { id: 10, content: './images/safe_substrate.png', label: '使用安全墊材', type: 'good', description: '建議使用廚房紙巾、爬蟲墊或防滑沖孔墊作為底材。避免使用細沙或碎木屑，以防守宮在捕食時誤食導致腸胃阻塞。' },
    { id: 11, content: './images/spot_cleaning.png', label: '每日局部清理', type: 'good', description: '每天花一分鐘夾走便便、清除髒污的墊材，能有效抑止環境細菌與寄生蟲滋生，給守宮一個乾淨清爽的家。' },
    { id: 12, content: './images/thermometer_check.png', label: '檢查溫度計數值', type: 'good', description: '守宮是冷血動物，環境溫度直接影響消化功能。應每天檢查溫溼度計，確保環境維持在舒適的範圍內。' },

    // --- bad behaviors (6 pairs) ---
    { id: 100, content: './images/dirty_water.png', label: '髒亂的水源', type: 'hazard', description: '長時間不更換的水盆會黏附排泄物或死昆蟲，滋生致命菌群。守宮飲用後極易引發嚴重的消化道感染或拒食。' },
    { id: 101, content: './images/glass_tapping.png', label: '拍擊玻璃箱', type: 'hazard', description: '拍擊或大力敲打玻璃飼養箱會產生劇烈的震動與噪音，對聽覺敏銳、膽小的守宮來說，這就像地震一樣可怕，會引發極大恐慌。' },
    { id: 102, content: './images/harsh_sunlight.png', label: '陽光強烈直射', type: 'hazard', description: '守宮屬於夜行性動物，皮膚薄弱，無法承受強光。陽光直射飼養箱會引發溫室效應，使箱內溫度飆升，導致守宮中暑甚至死亡。' },
    { id: 103, content: './images/high_handling_fall_risk.jpeg', label: '在高處把玩', type: 'hazard', description: '站在高處把玩或將守宮放在高桌上非常危險。一旦守宮受驚向前竄跳，摔落地面可能會導致嚴重的內出血或骨折。' },
    { id: 104, content: './images/tail_grabbing.png', label: '用力抓扯尾巴', type: 'hazard', description: '絕對不能用力抓扯守宮的尾巴！當牠們感受到強烈危險時，會啟動自切防禦機制——直接斷尾求生。雖然會慢慢長回來，但對身體元氣傷害極大。' },
    { id: 105, content: './images/wild_bug_danger.png', label: '餵食不明野外昆蟲', type: 'hazard', description: '野外捕捉的昆蟲體內通常含有未知的寄生蟲，甚至可能沾染了農藥或殺蟲劑。餵食野生昆蟲極容易導致守宮中毒身亡。' }
];
